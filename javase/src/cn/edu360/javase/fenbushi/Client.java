...
public class Client {
	...
	public static void main(String[] args) throws Exception {
		//新建socket对象并指定ip和端口
		Socket s = new Socket("192.168.31.27",8884);
		//因为输出的是字节，读取的是字符串
	...
	private static void writeJarFile(BufferedOutputStream bos) throws Exception {
	...
	private static void writeSaveJarPath(BufferedOutputStream bos) throws Exception {
	...
	private static void writeRequestHeader(BufferedOutputStream bos) throws Exception {
		//将请求头所占的字节大小写出去

...
//			校验
	...
	private static String saveJarFile(BufferedInputStream bis, String saveJarPath) {
		//读取8个字节
		byte[] buf = new byte[8];
	 ...
	 * @throws IOException
	 */
	public static String readFourByteToString(BufferedInputStream bis) throws IOException {
		//读取请求头,首先读取4个
		byte[] buf = new byte[4];
		bis.read(buf);
		//将4个字节转换成int值

...
public class ServerRunable implements Runnable {
	...
	private  String deallogin(String username, String password) {
		//判断保存密码的文件存在不存在
	...
	public  String dealregister(String username,String password) {
		File file = new File("D:/java/user.txt");
		Properties p = new Properties();
		if(file.exists()) {		
			try(Reader reader = new FileReader(file)) {
	...
	public String register(String username, String password, File file, Properties p) {
